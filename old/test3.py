...
def test_it():
    ...
    #for i in range(10):
    fut = pool.apply_async(f, (random.randint(0, 3), random.randint(0, 3), random.randint(0, 3), "ok"))
    # This returns a concurrent.futures.Future
    print("running it asynchronously 1")

    fut2 = pool.apply_async(f, (random.randint(0, 3), random.randint(0, 3), random.randint(0, 3), "ok"))
    # This returns a concurrent.futures.Future
